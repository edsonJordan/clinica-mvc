<link rel="stylesheet" href="<?php  echo RUTA_URL; ?>/css/403.css">
...
<main>
  ...
  <div class="flexy-center">
    <div class="button__container">
      <div class="button" id="connect">Conectar</div>
      <div class="button button--disabled" id="reload">Actualizar</div>
    </div>
    <div class="container" id="container">
      <svg class="computer svg-icon" id="computer"  width="1024" height="1024" viewbox="0 0 1024 1024">
      ...
      <svg class="server svg-icon" id="server"  width="1024" height="1024" viewbox="0 0 1024 1024">
    ...
    <div class="container__title" id="container__title">Acceso restringido</div>
  </div>
</main>
<!-- partial -->
</body>
...
<script type="text/javascript" src="<?php  echo RUTA_URL; ?>/public/js/403.js"></script>
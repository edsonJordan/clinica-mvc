...
?>
		...
		<form class="form" action="<?php echo RUTA_URL; ?>coprocultivo/agregar"  method="post">
		<div class=" col-sm-12 text-center ">
			...
			<div class="col-sm-4 ">
					<p for=""><b> Consistencia <i style="color:red;">*</i></b></p>
                		<div class="form-group row">
						<input type="text" name="consistencia" class="form-control  text-center" maxlength="40" placeholder="Ingrese comentario" required>
                        		</div>
					</div>
					...
					<p for=""><b> Color <i style="color:red;">*</i></b></p>
                		<div class="form-group row">
						<input type="text" name="color" class="form-control  text-center" maxlength="40" placeholder="Ingrese comentario" required>
                        		</div>
					</div>
					...
					<p for=""><b> Reaccion(ph) <i style="color:red;">*</i></b></p>
                		<div class="form-group row">
						<input type="text" name="reaccion_ph" class="form-control  text-center" maxlength="40" placeholder="Ingrese comentario" required>
                        		</div>
					</div>
						...
						<input type="checkbox" class="custom-control-input " id="moco" name="moco"  value="1">
						<label class="custom-control-label " for="moco">Moco</label>
							...
							<div class="col-sm-6 ">
							<div class=" form-group row custom-control custom-checkbox">
						<input type="checkbox" class="custom-control-input " id="sangre_macroscopica" name="sangre_macroscopica"  value="1">
					...
					<div class=" form-group row custom-control custom-checkbox">
				<input type="checkbox" class="custom-control-input " id="eritrocitos" name="eritrocitos"  value="1">
				<label class="custom-control-label " for="eritrocitos">Eritrocitos</label>
					...
					<div class=" form-group row custom-control custom-checkbox">
				<input type="checkbox" class="custom-control-input " id="leucocitos" name="leucocitos"  value="1">
				<label class="custom-control-label " for="leucocitos">Leucocitos</label>
					...
					<div class=" form-group row custom-control custom-checkbox">
				<input type="checkbox" class="custom-control-input " id="celulas_epiteliales" name="celulas_epiteliales"  value="1">
				<label class="custom-control-label " for="celulas_epiteliales">Celulas epiteliales</label>
					...
					<div class=" form-group row custom-control custom-checkbox">
				<input type="checkbox" class="custom-control-input " id="inv_parasitos" name="inv_parasitos"  value="1">
			...
			<div class="col-sm-4 ">
					...
					<div class=" form-group row custom-control custom-checkbox">
				<input type="checkbox" class="custom-control-input " id="resultado" name="resultado"  value="1">
				<label class="custom-control-label " for="resultado">Helicobacter Pylori</label>
					...
					<div class=" form-group row custom-control custom-checkbox">
				<input type="checkbox" class="custom-control-input " id="sangre_oculta" name="sangre_oculta"  value="1">
				<label class="custom-control-label " for="sangre_oculta">Sangre oculta</label>
					...
					<div class=" form-group row custom-control custom-checkbox">
				<input type="checkbox" class="custom-control-input " id="transferrina" name="transferrina"  value="1">
